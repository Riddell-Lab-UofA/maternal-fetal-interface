...
# Integration script
This is the workflow performed to integrate our datasets seen in this paper. This Rmarkdown script is fully reproducible as well as providing the output for the different parameters (e.g. QCs) used to integrate datasets. 
...
#Loading datasets
pla_25_6.data <- Read10X(data.dir = 'D:/Calgary placenta collaboration/Data to Deposit/25_6_basal_plate_Sc/')
pla_25_7.data <- Read10X(data.dir = 'D:/Calgary placenta collaboration/Data to Deposit/25_7_basal_plate_sc/')
pla_020325.data <- Read10X(data.dir = 'D:/Calgary placenta collaboration/Data to Deposit/020325_basal_plate_sc/')
pla_021125.data <- Read10X(data.dir = 'D:/Calgary placenta collaboration/Data to Deposit/021115_basal_plate_sc/')
pla_022025.data <- Read10X(data.dir = 'D:/Calgary placenta collaboration/Data to Deposit/022025_basal_plate_sc/')
pla_052725.data <- Read10X(data.dir = 'D:/Calgary placenta collaboration/Data to Deposit/052725_basal_plate_sc/')
```
...
mem_25_6.data <- Read10X(data.dir = "D:/Calgary placenta collaboration/Data to Deposit/25_6_mem/")
mem_25_7.data <- Read10X(data.dir = "D:/Calgary placenta collaboration/Data to Deposit/25_7_mem/")
mem_020325.data <- Read10X(data.dir = "D:/Calgary placenta collaboration/Data to Deposit/020325_mem/")
mem_021125.data <- Read10X(data.dir = "D:/Calgary placenta collaboration/Data to Deposit/021125_mem/")
mem_022025.data <- Read10X(data.dir = "D:/Calgary placenta collaboration/Data to Deposit/022025_mem/")
mem_052725.data <- Read10X(data.dir = "D:/Calgary placenta collaboration/Data to Deposit/052725_mem/")
```
...
myo_25_6_1.data <- Read10X(data.dir = "D:/Calgary placenta collaboration/Data to Deposit/25_6_1_myo/")
myo_25_6_2.data <- Read10X(data.dir = "D:/Calgary placenta collaboration/Data to Deposit/25_6_myo_2")
myo_25_7.data <- Read10X(data.dir = "D:/Calgary placenta collaboration/Data to Deposit/25_7_myo")
```
...
#Loading datasets
nuc_020325.data <- Read10X(data.dir = 'D:/Calgary placenta collaboration/Data to Deposit/020325_basal_plate_sn/')
nuc_052725.data <- Read10X(data.dir = 'D:/Calgary placenta collaboration/Data to Deposit/052725_basal_plate_sn/')
nuc_022025.data <- Read10X(data.dir = 'D:/Calgary placenta collaboration/Data to Deposit/022025_basal_plate_sn/')
nuc_021125.data <- Read10X(data.dir = 'D:/Calgary placenta collaboration/Data to Deposit/021125_basal_plate_sn/')
nuc_25_7.data <- Read10X(data.dir = 'D:/Calgary placenta collaboration/Data to Deposit/25_7_basal_plate_sn/')
nuc_25_6.data <- Read10X(data.dir = 'D:/Calgary placenta collaboration/Data to Deposit/25_6_basal_plate_sn/')
```
...
#Reading the Integrated Datasets
basal_plate <- readRDS(file = 'D:/Calgary placenta collaboration/Integrated Data/placenta.rds')
myometrium <- readRDS(file = 'D:/Calgary placenta collaboration/Integrated Data/myometrium.rds')
membrane <- readRDS(file = 'D:/Calgary placenta collaboration/Integrated Data/membrane.rds')
nuclei <- readRDS(file = 'D:/Calgary placenta collaboration/Integrated Data/nuclei.rds')
```
